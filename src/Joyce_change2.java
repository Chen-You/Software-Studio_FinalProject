...
public class Joyce_change2 extends JPanel implements MouseListener, Runnable {
	...
	public Joyce_change2(GameStage f, JoyceMon J) {
		this.gs = f;
		this.JJ = J;
		setLayout(null);
		initialIma();
	...
	private void initialIma() {
		...
		File f1 = new File("Ima/change02_1.png");
		try {
			bi = ImageIO.read(f1);
		} catch (IOException e) {
		...
		File f2 = new File("Ima/change02_2.png");
		try {
			bi2 = ImageIO.read(f2);
		} catch (IOException e) {
			// TODO Auto-generated catch block
		...
		File f3 = new File("Ima/change02_3.png");
		try {
			bi3 = ImageIO.read(f3);
		} catch (IOException e) {
			// TODO Auto-generated catch block
