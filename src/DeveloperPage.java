...
public class DeveloperPage extends JPanel implements MouseListener, Runnable {
	...
	protected void paintComponent(Graphics g) {
		...
		if(page == 1) g.drawImage(bi, 0, 0, 450, 750, null);
		else if(page == 2) g.drawImage(bi2, 0, 0, 450, 750, null);
		else if(page == 3) g.drawImage(bi3, 0, 0, 450, 750, null);
		else if(page == 4) g.drawImage(bi4, 0, 0, 450, 750, null);
		else if(page == 5) g.drawImage(bi5, 0, 0, 450, 750, null);
		else g.drawImage(bi6, 0, 0, 450, 750, null);
